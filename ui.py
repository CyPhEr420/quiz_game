...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.question_text = self.canvas.create_text(175,
                                                     175,
                                                     text="some question",
                                                     font=FONT,
                                                     fill=THEME_COLOR,
        ...
        self.ture_btn = Button(image=true_img, highlightthickness=0, command=self.true_pressed)
        self.ture_btn.grid(row=2, column=0)
